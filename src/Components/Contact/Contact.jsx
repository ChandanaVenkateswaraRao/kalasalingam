...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "db0dabe8-942a-4e78-a29d-1d8404b1e687");
  ...
  return (
    <div className='contact'>
        ...
        <div className="contact-col">
            ...
            <ul>
                <li><img src={mail_icon} alt="" /> Contact@venkey.dev</li>
                <li> <img src={phone_icon} alt="" />+91 99999 99999</li>
                <li><img src={location_icon} alt="" /> KrishananKovil , Virudhnagar <br /> Tamilnadu , 626126</li>
